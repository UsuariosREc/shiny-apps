...
\begin{center}
\includegraphics[width=3.5cm, height=1.5cm]{logo_msplus.jpg}
\end{center}
\end{minipage}
%}
...
\begin{minipage}[d]{40mm}
\begin{center}
\includegraphics[width=4.2cm, height=1.5cm]{logo_ssl_ult.jpeg}
\end{center}
\end{minipage}
%}
\\
...
\begin{tabular}{|p{111pt}|p{334pt}|}\hline
{\bf Nombre:} & {\small \Sexpr{nombre}}\\ \hline
{\bf Dirección:} & {\small \Sexpr{direc}}\\ \hline
{\bf Representante:} & {\small \Sexpr{repre}}\\ \hline
{\bf Teléfonos:} & {\small \Sexpr{telefono}}\\ \hline
\end{tabular}\\
...
{\bf\scriptsize Marca:} & {\small \Sexpr{marca}} &  & \\ \hline
\end{tabular}\\
...
{\bf\scriptsize Error 1 (\%)} & \Sexpr{error[4]*100} & \Sexpr{error[3]*100} & \Sexpr{error[2]*100} & \Sexpr{error[1]*100} \\ \hline
{\bf\scriptsize Error promedio (\%)} & \Sexpr{error[4]*100} & \Sexpr{error[3]*100} & \Sexpr{error[2]*100} & \Sexpr{error[1]*100} \\ \hline
\end{tabular}
\end{table}
